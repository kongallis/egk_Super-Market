...
<head>
    ...
    <script src="../../static/js/eshop/positionSticky.js"></script>
    <style>
        .navig a,
        h2 {
            color: white;
...
<body>
    <div class="navig">
        <div id="logo"><a href="${contextPath}/welcome/"><img
                    src="<c:url value='/static/css/header/img/android-icon-48x48.png'/>" alt="Adminpage"></a></div>
        <div class="achive" id="goleft"> <i class="fas fa-shopping-basket"
                style="font-size: 20px; color: white;">&nbsp;</i><a href="#"> E-Shop</a></div>
        <div class="achive"><a href="${contextPath}/contact"><i class="fas fa-address-book"
                    style="font-size: 20px;"></i> Contact us</a></div>
        <div class="achive" id="goleft"><a href="${contextPath}/chat"><i class="fas fa-comments"
                    style="font-size: 20px;"></i> Need Help?</a></div>
        <div class="achive"> <i class="fas fa-user" style="font-size: 20px;  color: white;">&nbsp; </i>
            <c:if test="${pageContext.request.userPrincipal.name != null}">
                <form id="logoutForm" method="POST" action="${contextPath}/logout">
                    <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
                </form>
                <h2><span>${pageContext.request.userPrincipal.name},</span> <a
        ...
        <nav id="toggleNav" class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <a class="nav-item nav-link active" href="${contextPath}/welcome/">Home <span
    ...
    <div class="filterChoices">
        <button class="btn btn--white" id="sortPerPrice">Price &darr;</button>
        <button class="btn btn--white" id="sortPerPriceAsc">
            Price &uarr;
        </button>
        <div class="bioSwitch">
            ...
            <div class="row cartClearCart">
                <div class="col">
                    <button type="button" id="carttab" class="btn " data-toggle="modal" data-target="#cart">
                        ...
                        <span id="total-amount" class="total-amount">0</span> &euro; )</button><button
                        class="clear-cart btn btn-danger"><i class="fas fa-trash-alt"></i></button>
                </div>
            </div>
        </nav>
